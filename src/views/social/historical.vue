    ...
    <div class="historicalArcTop">
      <div class="title">
        ...
        <div class="yearChange">
          <el-date-picker v-model="yearVal" value-format="yyyy" type="year" size="mini" width="130px" placeholder="选择年" @change="changeYear" />
        </div>
      </div>
    </div>
    <div v-loading="loading" class="historicalTable">
      <div v-for="(itemes, index) in tableData" :key="index" class="itemes">
        <div class="itemTopLab" :class="{ act: itemes.act }">
          ...
          <div>
            <p class="title">
              {{ itemes.month }}社保报表 <span>{{ itemes.creationTime }}</span>
            </p>
        ...
        <div v-show="itemes.act" class="itemDropDown">
          ...
          <el-table id="item" :data="itemes.contentData" height="300" border style="width: 100%;text-align: center">
