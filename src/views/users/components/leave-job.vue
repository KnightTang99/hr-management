    ...
    <div>
      <el-form ref="ruleForm" :model="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="开始时间：" prop="startTime">
          <el-date-picker v-model="ruleForm.data.start_time" type="datetime" placeholder="选择日期" :disabled="computeOpType" />
        </el-form-item>
        <el-form-item label="结束时间：" prop="endTime">
          <el-date-picker v-model="ruleForm.data.end_time" type="datetime" placeholder="选择日期" :disabled="computeOpType" />
        </el-form-item>
        ...
        <el-form-item label="申请原因：" prop="cause">
          <el-input v-model="ruleForm.data.reason" type="textarea" style="width: 400px;" placeholder="显示请假人填写的请假原因" :disabled="computeOpType" />
        </el-form-item>
...
<script>
import { getApprovalsDetail, approvalsDel, approvalsPass, approvalsReject, applyeLave } from '@/api/approvals'
export default {
