    ...
    <div>
      <el-form ref="ruleForm" :model="ruleForm" label-width="120px" class="demo-ruleForm">
        ...
        <el-form-item label="加班开始时间" prop="timeValue">
          <el-date-picker v-model="ruleForm.data.start_time" format="yyyy-MM-dd HH:mm:ss" type="date" placeholder="选择日期" :disabled="computeOpType" />
        </el-form-item>
        <el-form-item label="加班结束时间" prop="timeValue">
          <el-date-picker v-model="ruleForm.data.end_time" type="date" format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期" :disabled="computeOpType" />
        </el-form-item>
        <el-form-item label="申请原因" prop="evaluate">
          <el-input v-model="ruleForm.data.reason" type="textarea" style="width: 400px;" placeholder="显示加班人填写的加班原因" :disabled="computeOpType" />
        </el-form-item>
        <div class="buttones" style="text-align: center;margin-top: 40px">
          <el-form-item>
            ...
            <!-- </el-form-item> -->
            <el-button v-show="ruleForm.stateOfApproval == 4 && tabLab == 'launch'" type="primary" @click="btnSave">提交</el-button>
          </el-form-item>
        </div>
      </el-form>
    </div>
