  ...
  <div class="enterApproval">
    <div class="contLeft">
      <div class="topTit">
        ...
        <div class="info">
          <p class="name">
            <strong> {{ information.user.fullName }} </strong>
          </p>
          <p>
            <span>学历：{{ information.user.academic }}</span> 毕业院校： {{ information.user.college }}
          </p>
          <p>
            <span>入职部门： {{ information.user.department }}</span> 入职岗位：{{ information.user.post }}
          </p>
        </div>
      </div>
      <div class="content">
        <p v-for="(item, index) in information.body" :key="index">
          <span>{{ item.key }} </span> {{ item.val }}
        </p>
      </div>
    </div>
    <div class="contRit">
